...
| [pollutant-concentration-to-aqi](https://github.com/lmarzen/pollutant-concentration-to-aqi)                   | [GNU Lesser General Public License v2.1](https://github.com/lmarzen/pollutant-concentration-to-aqi/blob/main/LICENSE)                                             |  C library that converts pollutant concentrations to Air Quality Index(AQI).                              |
